# Generated by Django 4.2.7 on 2025-05-12 14:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('reviewer', 'Reviewer'), ('approver', 'Approver'), ('contributor', 'Contributor'), ('observer', 'Observer'), ('responsible', 'Responsible'), ('consultant', 'Consultant'), ('other', 'Other')], default='contributor', max_length=50)),
                ('history_id', models.CharField(max_length=100, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replacer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='replacing', to='core.person')),
