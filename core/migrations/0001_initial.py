# Generated by Django 4.2.7 on 2025-05-01 15:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(max_length=100, primary_key=True, serialize=False)),
                ('history_id', models.CharField(db_index=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('history_id', models.CharField(max_length=100, unique=True)),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teams', to='core.department')),
            ],
            options={
                'db_table': 'team',
                'ordering': ['name'],
